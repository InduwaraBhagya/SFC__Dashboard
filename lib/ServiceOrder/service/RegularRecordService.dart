        ...
        final records = rawRecords
            .map((item) {
              try {
                ...
                if (mapItem.containsKey('plannedEvent') &&
                    mapItem['plannedEvent'] != null) {
                  final plannedEvent =
                      mapItem['plannedEvent'] as Map<String, dynamic>;
                  mapItem['serviceRequiredDate'] =
                      plannedEvent['serviceRequiredDate'];
