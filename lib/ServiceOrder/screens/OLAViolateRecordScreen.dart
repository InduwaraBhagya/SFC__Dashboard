// REDESIGNED OLA VIOLATION RECORD SCREEN - SFC DASHBOARD
...
class OLAViolateRecordScreen extends StatefulWidget {
  ...
  const OLAViolateRecordScreen({super.key, required this.user, this.onBack});
        ...
        children: [
          Row(
            children: [
              Expanded(
                child: Text(
                  'OLA Violated Records (${_getFilteredRecords().length} of $_totalCount Records)',
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text('No OLA violations found.', style: GoogleFonts.outfit(fontSize: 14, color: Colors.grey.shade500)),
