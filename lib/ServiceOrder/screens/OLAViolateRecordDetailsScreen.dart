                    ...
                    _buildInfoSection(
                      ...
                      [
                        ...
                        _Field('Start Date and Time',
                            record.peTask?.actualTaskCreatedDate ?? '-'),
                        _Field('Finish Date and Time',
                            record.peTask?.aCtualTaskCompleteDate ?? '-'),
                        _Field(
                            'Time Spent', record.peTask?.estimatedTime ?? '-'),
        ...
        children: [
          ...
          SingleChildScrollView(
            ...
            child: DataTable(
              ...
              rows: [
                DataRow(cells: [
                  DataCell(Text(record.peTask?.task ?? 'confirm w/ customer',
