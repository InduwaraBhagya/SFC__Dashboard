...
class OPMCReportScreen extends StatelessWidget {
  final Map<String, dynamic> user;
  final VoidCallback onBack;

  const OPMCReportScreen({
    super.key,
    required this.user,
  ...
  bool _isOPMCSupervisor() {
    ...
    return userRoleId == 8 || (userRole != null && userRole.toString().contains('OPMC Supervisor'));
  }

  @override
  Widget build(BuildContext context) {
    if (_isOPMCSupervisor()) {
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            const Icon(Icons.pie_chart_outline, size: 80, color: Color(0xFF1A237E)),
            const SizedBox(height: 16),
            Text(
              'OPMC Report Data Coming Soon',
              style: GoogleFonts.poppins(
                fontSize: 18,
                fontWeight: FontWeight.w600,
                color: const Color(0xFF2C3E50),
            ...
            const SizedBox(height: 8),
            Text(
              'As an OPMC Supervisor, you will be able to see\nOPMC workgroup metrics here.',
              textAlign: TextAlign.center,
