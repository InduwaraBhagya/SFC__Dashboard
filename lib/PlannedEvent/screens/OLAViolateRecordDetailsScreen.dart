          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                //     _Field('Work Order Comments', record.plannedEvent?.woComments ?? 'N/A'),
                //     _Field('PE Work Order Comments', record.plannedEvent?.peWoComments ?? 'N/A'),
                //     _Field('Fiber PE Number', record.plannedEvent?.fiberPeNo ?? 'N/A'),
                //     _Field('Fiber SO ID', record.plannedEvent?.fiberSoId ?? 'N/A'),
                //     _Field('Product SO ID', record.plannedEvent?.productSoId ?? 'N/A'),
                //     _Field('Fiber PE Task Name', record.plannedEvent?.fiberPeTaskName ?? 'N/A'),
                //     _Field('Fiber PE Task Workgroup', record.plannedEvent?.fiberPeTaskWg ?? 'N/A'),
                //     _Field('PE Created Date', record.plannedEvent?.peCreatedDate ?? 'N/A'),
                //     _Field('Is Hold', record.plannedEvent?.isHold?.toString() ?? 'N/A'),
                //   ],
                // ),
